...
#define UI1()                               \
	...
	outtextxy(220, 70, p->Info.Snum);      \
	outtextxy(30, 70, _T("姓名："));        \
	outtextxy(110, 70, p->Info.Sname);      \
	outtextxy(30, 110, _T("年龄："));       \
	outtextxy(110, 110, p->Info.Sage);		\
	outtextxy(300, 70, _T("性别："));		\
	outtextxy(380, 70, p->Info.Ssex);		\
	outtextxy(150, 110, _T("生日："));		\
	outtextxy(230, 110, p->Info.Sbirth);	\
	outtextxy(30, 150, _T("电话："));		\
	outtextxy(110, 150, p->Info.Stel);		\
	outtextxy(30, 190, _T("邮箱："));		\
	outtextxy(110, 190, p->Info.Smail);		\
	outtextxy(30, 230, _T("成绩："));		\
	outtextxy(100, 270, _T("大学英语"));		\
	outtextxy(140, 310, p->sc.DYgrade);		\
	outtextxy(190, 270, _T("高等数学"));		\
	outtextxy(230, 310, p->sc.GSgrade);		\
	outtextxy(280, 270, _T("线性代数"));		\
	outtextxy(320, 310, p->sc.XDgrade);		\
...
void Modify_Sscore() {
	...
	InputBox(s, 10, "请输入修改的学生成绩（大英、线代、高数）");//信息输入
...
void Menu() {
	...
	rectangle(240, 150, 400, 180);
	outtextxy(266, 150, _T("教师系统"));
	rectangle(240, 200, 400, 230);
	outtextxy(266, 200, _T("学生系统"));
	MOUSEMSG m2;
